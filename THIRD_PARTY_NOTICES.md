...
RVC.cpp implements a limited RVC-style ONNX inference protocol. The Python WebUI,
...
RVC.cpp's own source is covered by the root `LICENSE`. References to third-party
